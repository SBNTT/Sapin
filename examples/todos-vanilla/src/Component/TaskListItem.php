...
final readonly class TaskListItem
{
    ...
    public function getInProgressState(): TaskState
    {
        return TaskState::IN_PROGRESS;
    }

    public function getDoneState(): TaskState
    {
    ...
    >
        ...
        <div class="flex items-center gap-3 mr-2 opacity-0 group-hover:opacity-100 transition">
            <a
                    ...
                    href="/update-task-state?id={{ $this->task->id }}&state={{ $this->getInProgressState()->value }}"
            ...
            <a
                    ...
                    href="/update-task-state?id={{ $this->task->id }}&state={{ $this->getDoneState()->value }}"
